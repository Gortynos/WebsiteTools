...
TRANSLATIONS = {
    "pl": {
        ...
        "text_diff.invalid_input": "Nieprawidłowe dane wejściowe.",
        "text_diff.no_changes": "Brak różnic między tekstem A i B.",
        "text_diff.no_changes_with_options": "Brak różnic po zastosowaniu wybranych opcji porównania.",
        "text_diff.success": "Porównanie zakończone.",
    ...
    "en": {
        ...
        "text_diff.invalid_input": "Invalid input data.",
        "text_diff.no_changes": "No differences between text A and B.",
        "text_diff.no_changes_with_options": "No differences after applying selected comparison options.",
        "text_diff.success": "Comparison completed.",
